...
func pluginUsage() {
  ...
  ctfcode plugin install <source> [--yes] [--dry-run] [--link] [--replace]
  ctfcode plugin list
  ctfcode plugin show <name>
  ctfcode plugin enable <name>
  ctfcode plugin disable <name>
  ctfcode plugin remove <name>
  ctfcode plugin doctor <name>`)
}
