...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — ctfcode end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "ctfcode", "path to the ctfcode binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 ctfcode e2e benchmark\n\n")
